...
const ideasStaticDir = fs.existsSync(path.join(__dirname, '../GammaVase/public/ideas'))
  ? path.join(__dirname, '../GammaVase/public/ideas')
  : path.join(__dirname, './uploads/ideas');
app.use('/ideas', express.static(ideasStaticDir));
